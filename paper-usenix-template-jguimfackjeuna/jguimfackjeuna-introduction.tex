...
Die \textbf{Hauptforschungsfrage} lautet: Inwieweit ermoeglicht eine \shap{}-Analyse
eines \gb{}-Klassifikators auf dem CICIoT2023-Datensatz eine pro-Angriffsklasse
nachvollziehbare Zuordnung von Netzwerkmerkmalen zu Klassifikationsentscheidungen,
und in welchem Verhaeltnis steht diese Erklaerbarkeit zur erreichten \ba{}?
Drei Teilfragen konkretisieren diese:
(1)~Welche Klassen werden durch das Klassenungleichgewicht systematisch schlechter erkannt?
(2)~Welchen messbaren Einfluss hat \pca{} auf \ba{} und \shap{}-Interpretierbarkeit?
(3)~Stimmen die identifizierten \shap{}-Top-Features mit den dokumentierten
Angriffssignaturen des CICIoT2023 ueberein~\cite{neto2023ciciot2023}?
