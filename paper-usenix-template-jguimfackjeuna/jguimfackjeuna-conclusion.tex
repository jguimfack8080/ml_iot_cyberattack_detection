...
\textbf{Ausblick.}
Die \shap{}-Analyse wurde fuer beide Pipelines durchgefuehrt und ihre Qualitaet quantitativ
(Faithfulness, Stabilitaet, Jaccard-Aehnlichkeit) sowie qualitativ (semantische Validierung)
bewertet.
Sie belegt eine hohe Treue der Erklaerungen und einen Zielkonflikt zwischen Stabilitaet und
Interpretierbarkeit der \pca{}-Komponenten (vgl.\ Abschnitt~\ref{evaluation}).
