...
\textbf{Ausblick.}
Die \shap{}-Analyse und ihre Qualitaetsbewertung nach Hermosilla et al.\
\cite{hermosilla2025xai_forensic} (Fidelitaet, Konsistenz) wurden fuer Pipeline~B
abgeschlossen; die Jaccard-Aehnlichkeit ist methodisch nicht anwendbar, da \pca{}-Komponenten
und Originalmerkmale verschiedene Feature-Raeume bilden (vgl.\ Kapitel~\ref{evaluation}).
