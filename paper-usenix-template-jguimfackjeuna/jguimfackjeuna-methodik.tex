...
Die Normalverteilung aller Klassen bleibt dabei erhalten.

Unendliche Werte (Infinity), die im Rohdatensatz auftreten, werden vor dem Preprocessing
durch fehlende Werte (NaN) ersetzt.
Der anschliessende SimpleImputer~\cite{neto2023ciciot2023} fuellt fehlende Werte mit dem
Spaltenmedian auf.
...
Mehrklassenklassifikation der zahlenmaeßig unterrepraesentierten Kategorien erfolgt.
...
Die Qualitaet der \shap{}-Erklaerungen wird anhand der Bewertungsmetriken aus Hermosilla et
al.\ \cite{hermosilla2025xai_forensic} ueberprueft: Fidelitaet, Konsistenz und
